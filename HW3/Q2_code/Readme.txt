...
ansible-playbook ovs-network.yml 
...
execute the code in the format 
List of networks availabel
ovs-net-nat
ovs-net-l2
ovs-net-routed
ovs-net-other
The list has to be among these

 
ansible-playbook bonus_question.yml -e '{"names:{"testvm1":'ovs-net-nat:ovs-net-l2'}"}'
